...
df_bioactivity_guts=pd.read_csv('../results/bioactivity/bioactivities_by_cid_guts.csv', sep=";")
df_bioactivity_drugs=pd.read_csv('../results/bioactivity/bioactivities_by_cid_drugs.csv', sep=";")
...
result_df_guts.to_csv('../results/bioactivity/filtered_bioactivity_result_guts.csv',sep=";",index=False)
...
df_cids_guts.to_csv("../results/bioactivity/guts_comps_cids_bioactivity.csv", sep=';',index=False)
...
result_df_drugs.to_csv('../results/bioactivity/filtered_bioactivity_result_drugs.csv',sep=";",index=False)
df_cids_drugs["bioactivity"]=df_cids_drugs.apply(lambda row:check_bioactivity(row["cid"], pd.unique(df_bioactivity_drugs["cid"]), pd.unique(df_bioactivity_filtered_drugs["cid"]),pd.unique(result_df_drugs[result_df_drugs["my_activity"]=="Active"]["cid"])), axis = 1)
df_cids_drugs.to_csv("../results/bioactivity/drugs_comps_cids_bioactivity.csv", sep=';',index=False)